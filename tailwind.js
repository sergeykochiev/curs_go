...
`,
    ...
    for (let c = 0; c < t.length; c++) {
      ...
      if (m === Re) (a += t.slice(c, c + 2)), (c += 1);
        ...
        let h = t.slice(g, c + 1);
        h.charCodeAt(2) === To && o.push(He(h.slice(2, -2)));
      } else if (m === Co || m === Ao) {
        let g = c;
        for (let h = c + 1; h < t.length; h++)
          if (((u = t.charCodeAt(h)), u === Re)) h += 1;
            ...
            if (u === We && t.charCodeAt(h + 1) === ke)
              throw new Error(
                `Unterminated string: ${t.slice(g, h + 1) + String.fromCharCode(m)}`,
              );
            if (u === ke)
              throw new Error(
                `Unterminated string: ${t.slice(g, h) + String.fromCharCode(m)}`,
              );
          }
        a += t.slice(g, c + 1);
      } else {
        ...
        if (m === ke) {
          ...
          for (let A = c + 2; A < t.length; A++)
            ...
            } else if (w === -1 && u === No) w = a.length + A - h;
        ...
        } else if (m === We && a.charCodeAt(0) === wt)
          (s = Pe(a)), i ? i.nodes.push(s) : r.push(s), (a = ""), (s = null);
          ...
          if (((d = d.slice(0, -1)), a.length > 0))
            if (a.charCodeAt(0) === wt)
              (s = Pe(a)),
                i ? i.nodes.push(s) : r.push(s),
                (a = ""),
                (s = null);
            else {
              let h = a.indexOf(":");
...
`,
  ...
  function B(t, r = []) {
    return t.charCodeAt(0) === Ko ? Pe(t, r) : L(t, r);
  }
  function l(t, r, o = !1) {
  ...
  function ve(t, r, o = 3) {
    ...
    function h(k, A, b = {}, y = 0) {
      if (k.kind === "declaration") {
        ...
        if (k.value.includes("var("))
          if (b.theme && k.property[0] === "-" && k.property[1] === "-")
            for (let S of Ye(k.value)) g.get(S).add(k.property);
          ...
          for (let D of k.nodes)
            D.kind === "declaration" &&
              (D.property === "initial-value"
                ? (O = D.value)
                : D.property === "inherits" && (_ = D.value === "true"));
          _ ? c.push(l(V, O ?? "initial")) : m.push(l(V, O ?? "initial"));
        }
        i.add(k.params);
        let S = { ...k, nodes: [] };
        for (let V of k.nodes) h(V, S.nodes, b, y + 1);
    ...
    e: for (let [k, A] of s)
      for (let b of A) {
        if (lr(b.property, r.theme, g)) {
          if (b.property.startsWith(r.theme.prefixKey("--animate-")))
            for (let V of nr(b.value)) u.add(V);
          continue;
        }
        let S = k.indexOf(b);
        if ((k.splice(S, 1), k.length === 0)) {
          let V = Uo(w, (O) => O.kind === "rule" && O.nodes === k);
            ...
            (re(S, (D, { replaceWith: P }) => {
              ...
              if (
                (re(D.nodes, (F, { replaceWith: oe }) => {
                  if (
                    F.kind == "word" &&
                    F.value.toLowerCase() === "currentcolor"
                  ) {
                    (M = !0), (V = !0);
                    return;
                  }
                  ...
                  do {
                    ...
                    if (
                      (n.add(p),
                      (V = !0),
                      (ue = r.theme.resolveValue(null, [f.value])),
                      !ue)
                    ) {
                      Y = !0;
                      return;
                ...
                let F = D.nodes.findIndex(
                  (ee) =>
                    ee.kind === "separator" && ee.value.trim().includes(","),
                );
                if (F === -1) return;
    ...
    if (o & 1) {
      let k = [];
      if (
        (c.length > 0 && k.push(B(":root, :host", c)),
        m.length > 0 && k.push(B("*, ::before, ::after, ::backdrop", m)),
        k.length > 0)
      ) {
        let A = w.findIndex(
          (b) =>
...
`;
  ...
  function sr(t) {
    ...
    let r = !1;
    Ze.some((i) => t.includes(i)) &&
      ((ar.lastIndex = 0),
      (t = t.replace(ar, (i, s) => ((r = !0), `$${Ze.indexOf(s)}$(`))));
    let o = "",
      e = [];
    for (let i = 0; i < t.length; i++) {
      let s = t[i];
    ...
    for (let [g, h] of m) {
      ...
      }
      {
        ...
        if (k !== -1) {
          ...
          let b =
            d === null || w.modifier?.kind === "arbitrary" ? null : `${h}/${d}`;
  ...
  function $t(t) {
    if (t[0] === "[" && t[t.length - 1] === "]") {
      ...
      return !me(r) || r.length === 0 || r.trim().length === 0
        ? null
  ...
  function q(t, r) {
    ...
    for (let o of r) if (Mo[o]?.(t)) return o;
    return null;
  }
  var Bo = /^url\(.*\)$/;
  function hr(t) {
  ...
  function Wo(t) {
    return z(t, " ").every(
      (r) => et(r) || kr(r) || r === "thin" || r === "medium" || r === "thick",
    );
  }
  ...
  var ce = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/,
    Xo = new RegExp(`^${ce.source}$`);
  function kr(t) {
    return Xo.test(t) || _e(t);
  }
  var ei = new RegExp(`^${ce.source}%$`);
  function St(t) {
    return ei.test(t) || _e(t);
  }
  var ti = new RegExp(`^${ce.source}s*/s*${ce.source}$`);
  function ri(t) {
  ...
  var oi = [
    ...
    ii = new RegExp(`^${ce.source}(${oi.join("|")})$`);
  function et(t) {
    return ii.test(t) || _e(t);
  }
  function ni(t) {
    let r = 0;
    for (let o of z(t, " ")) {
  ...
  var ai = ["deg", "rad", "grad", "turn"],
    si = new RegExp(`^${ce.source}(${ai.join("|")})$`);
  function ui(t) {
    return si.test(t);
  }
  var ci = new RegExp(`^${ce.source} +${ce.source} +${ce.source}$`);
  function fi(t) {
    return ci.test(t);
  }
  function E(t) {
  ...
  function xr(t) {
    ...
    function o(n, f) {
      let p = /(\d+)_(\d+)/g;
      function* x(N) {
        for (let R of t.keysInNamespaces(N))
          yield R.replace(p, ($, T, K) => `${T}.${K}`);
      }
      let v = [
        "1/2",
        "1/3",
      ...
      r.suggest(n, () => {
        ...
        for (let R of f()) {
          ...
          let $ = [...(R.values ?? []), ...x(R.valueThemeKeys ?? [])],
            T = [...(R.modifiers ?? []), ...x(R.modifierThemeKeys ?? [])];
          R.supportsFractions && $.push(...v),
            R.hasDefaultValue && $.unshift(null),
            N.push({
        ...
        return (v) => {
          ...
          if (v.value)
            if (v.value.kind === "arbitrary") {
              ...
              (N = v.value.value), (R = v.value.dataType);
            } else {
              if (
                ((N = t.resolve(
                ...
                N === null && f.supportsFractions && v.value.fraction)
              ) {
              ...
              if (N === null && x && f.handleNegativeBareValue) {
                if (
                  ((N = f.handleNegativeBareValue(v.value)),
    ...
    r.static("container", () => {
      ...
      for (let p of n)
        f.push(j("@media", `(width >= ${p})`, [l("max-width", p)]));
      return f;
    }),
    ...
    function g({ negative: n }) {
      return (f) => {
        ...
        if (f.value.kind === "arbitrary") {
          ...
          !p && E(f.value.value) && (p = `${f.value.value}deg`),
          !p)
        )
          return;
    ...
    let w = () => U([C("--tw-scroll-snap-strictness", "proximity", "*")]);
    ...
    e("grid-flow-row", [["grid-auto-flow", "row"]]),
      ...
      i("grid-cols", {
        ...
        handleBareValue: ({ value: n }) =>
          Tt(n) ? `repeat(${n}, minmax(0, 1fr))` : null,
        ...
        r.functional(p, (v) => {
          ...
          if (v.value.kind === "arbitrary") {
            ...
            switch (
              ...
              default:
                return (
                  (N = Q(N, v.modifier, t)), N === null ? void 0 : x.color(N)
                );
            }
          }
          {
            let N = Z(v, t, ["--border-color", "--color"]);
          ...
          }
          {
            ...
            if (E(v.value.value)) {
              let R = x.width(`${v.value.value}px`);
              return R ? [n(), ...R] : void 0;
            }
          }
        }),
        ...
        x = function ({ negative: N }) {
          return (R) => {
            ...
            if (R.value.kind === "arbitrary") {
              ...
              let K = R.value.value;
              switch (R.value.dataType ?? q(K, ["angle"])) {
                case "angle":
                  return (
                    (K = N ? `calc(${K} * -1)` : `${K}`),
                    [
                      ...
                      l(
                        "background-image",
                        `linear-gradient(var(--tw-gradient-stops,${K}))`,
                      ),
                    ]
                  );
                default:
          ...
          return (R) => {
            if (R.value?.kind === "arbitrary") {
              ...
              return [
                ...
                l(
                  "background-image",
                  `conic-gradient(var(--tw-gradient-stops,${K}))`,
                ),
              ];
            }
            let $ = p(R.modifier);
            ...
            if (E(T))
              return (
                (T = N ? `calc(${T}deg * -1)` : `${T}deg`),
                [
                  l("--tw-gradient-position", `from ${T} ${$}`),
                  l(
                    "background-image",
                    "conic-gradient(var(--tw-gradient-stops))",
                  ),
    ...
    A("from", {
      ...
      r.functional("mask", (n) => {
        ...
        switch (
          n.value.dataType ??
          q(f, ["image", "percentage", "position", "bg-size", "length", "url"])
        ) {
          case "percentage":
          case "position":
        ...
        if (p.value) {
          if (p.value.kind === "arbitrary") {
            ...
            switch (
              ...
              case "percentage":
                return p.modifier || !E(x.slice(0, -1))
                  ? void 0
                  : f.position(x);
              default:
                return p.modifier ? void 0 : f.position(x);
          ...
          }
          {
            ...
            switch (x) {
              case "number": {
                ...
                return !v || !ye(p.value.value)
                  ? void 0
                  : f.position(`calc(${v} * ${p.value.value})`);
              }
              case "percentage":
                return E(p.value.value.slice(0, -1))
        ...
        position(x) {
          ...
          for (let N of ["top", "right", "bottom", "left"])
            p[N] &&
              ...
              v.push(l(`--tw-mask-${N}-${f}-position`, x)));
          return v;
        },
      });
    }
      ...
      r.functional("stroke", (n) => {
        if (n.value) {
          if (n.value.kind === "arbitrary") {
            ...
            switch (
              n.value.dataType ??
              q(f, ["color", "number", "length", "percentage"])
            ) {
              case "number":
              case "length":
              case "percentage":
      ...
      r.functional("font", (n) => {
        if (!(!n.value || n.modifier)) {
          if (n.value.kind === "arbitrary") {
            ...
            switch (
              n.value.dataType ??
              q(f, ["number", "generic-name", "family-name"])
            ) {
              case "generic-name":
              case "family-name":
      ...
      r.functional("filter", (v) => {
        ...
        r.functional("backdrop-filter", (v) => {
          if (!v.modifier) {
            ...
            if (v.value.kind === "arbitrary")
              return [
                l("-webkit-backdrop-filter", v.value.value),
                l("backdrop-filter", v.value.value),
              ];
            switch (v.value.value) {
              case "none":
                return [
        ...
        i("blur", {
          themeKeys: ["--blur"],
          handle: (v) => [p(), l("--tw-blur", `blur(${v})`), l("filter", n)],
        }),
        ...
        i("backdrop-brightness", {
          ...
          handle: (v) => [
            x(),
            l("--tw-backdrop-brightness", `brightness(${v})`),
            l("-webkit-backdrop-filter", f),
            l("backdrop-filter", f),
          ],
        }),
        ...
        i("backdrop-contrast", {
          ...
          handle: (v) => [
            x(),
            l("--tw-backdrop-contrast", `contrast(${v})`),
            l("-webkit-backdrop-filter", f),
            l("backdrop-filter", f),
          ],
        }),
        ...
        i("backdrop-grayscale", {
          ...
          handle: (v) => [
            x(),
            l("--tw-backdrop-grayscale", `grayscale(${v})`),
            l("-webkit-backdrop-filter", f),
            l("backdrop-filter", f),
          ],
        }),
        ...
        i("backdrop-hue-rotate", {
          ...
          handle: (v) => [
            x(),
            l("--tw-backdrop-hue-rotate", `hue-rotate(${v})`),
            l("-webkit-backdrop-filter", f),
            l("backdrop-filter", f),
          ],
        }),
        ...
        i("backdrop-saturate", {
          ...
          handle: (v) => [
            x(),
            l("--tw-backdrop-saturate", `saturate(${v})`),
            l("-webkit-backdrop-filter", f),
            l("backdrop-filter", f),
          ],
        }),
        ...
        r.functional("drop-shadow", (v) => {
          ...
          if (
            (v.modifier &&
              (v.modifier.kind === "arbitrary"
                ? (N = v.modifier.value)
                : E(v.modifier.value) && (N = `${v.modifier.value}%`)),
            !v.value)
          ) {
          ...
          if (v.value.kind === "arbitrary") {
            let R = v.value.value;
            switch (v.value.dataType ?? q(R, ["color"])) {
              case "color":
                return (
                  (R = Q(R, v.modifier, t)),
                  R === null
          ...
          {
            let R = t.get([`--drop-shadow-${v.value.value}`]),
          ...
          {
            let R = Z(v, t, ["--drop-shadow-color", "--color"]);
            if (R)
              return R === "inherit"
                ? [
                    p(),
        ...
        i("backdrop-opacity", {
          ...
          handle: (v) => [
            x(),
            l("--tw-backdrop-opacity", `opacity(${v})`),
            l("-webkit-backdrop-filter", f),
            l("backdrop-filter", f),
          ],
        }),
      ...
      r.static("outline-hidden", () => [
        ...
        r.functional("outline", (f) => {
          ...
          if (f.value.kind === "arbitrary") {
            ...
            switch (
              f.value.dataType ??
              q(p, ["color", "length", "number", "percentage"])
            ) {
              case "length":
              case "number":
              case "percentage":
    ...
    i("opacity", {
      themeKeys: ["--opacity"],
      handleBareValue: ({ value: n }) => (tt(n) ? `${n}%` : null),
            ...
            if (f) {
              ...
              if (n.modifier) {
                ...
                if (!v && ye(n.modifier.value)) {
                  let R = t.resolve(null, ["--spacing"]);
                  if (!R) return null;
                  v = `calc(${R} * ${n.modifier.value})`;
                }
                if ((!v && n.modifier.value === "none" && (v = "1"), !v))
                  return null;
                let N = [l("font-size", p)];
                return v && N.push(l("line-height", v)), N;
              }
      ...
      r.functional("text-shadow", (n) => {
        ...
        switch (n.value.value) {
          ...
          case "inherit":
            return n.modifier
              ? void 0
              : [P(), l("--tw-text-shadow-color", "inherit")];
        }
        {
        ...
        }
        {
          ...
          if (p)
            return [
              P(),
              l("--tw-text-shadow-color", G(p, "var(--tw-text-shadow-alpha)")),
            ];
        }
      }),
      o("text-shadow", () => [
              ...
              case "color":
                return (
                  ...
                  K === null
                    ...
                    : [
                        p(),
                        l("--tw-shadow-color", G(K, "var(--tw-shadow-alpha)")),
                      ]
                );
              default:
                return [
        ...
        r.functional("inset-shadow", ($) => {
            ...
            return K === null
              ...
              : [
                  ...
                  ...fe(
                    ...
                    K,
                    T,
                    (le) => `var(--tw-inset-shadow-color, ${le})`,
                  ),
                  l("box-shadow", n),
                ];
          }
              ...
              default:
                return [
                  ...
                  ...fe(
                    ...
                    K,
                    T,
                    (ht) => `var(--tw-inset-shadow-color, ${ht})`,
                    "inset ",
                  ),
                  l("box-shadow", n),
                ];
          ...
          switch ($.value.value) {
            ...
            case "inherit":
              return $.modifier
                ? void 0
                : [p(), l("--tw-inset-shadow-color", "inherit")];
          }
          {
      ...
      r.functional("ring", ($) => {
        ...
        if ($.value.kind === "arbitrary") {
          ...
          switch ($.value.dataType ?? q(T, ["color", "length"])) {
            case "length":
              return $.modifier
                ? void 0
                : [p(), l("--tw-ring-shadow", v(T)), l("box-shadow", n)];
            default:
              return (
                (T = Q(T, $.modifier, t)),
        ...
        r.functional("inset-ring", ($) => {
          ...
          }
          {
            ...
            let T = t.resolve($.value.value, ["--ring-width"]);
            if (
              (T === null && E($.value.value) && (T = `${$.value.value}px`), T)
            )
              return [
                p(),
                l("--tw-inset-ring-shadow", N(T)),
...
`);
            ...
            o.utilities.suggest(r.slice(0, -2), () => {
              ...
              for (let [
                ...
                for (let g of o.theme.keysInNamespaces(m)) a.push(g);
              }
  ...
  function fe(t, r, o, e, i = "") {
    ...
    return s
      ? [
          l(t, d(ze(r, e))),
          B("@supports (color: lab(from red l a b))", [l(t, d(a))]),
        ]
      : [l(t, d(a))];
  }
  ...
  var Rt = { "--alpha": gi, "--spacing": hi, "--theme": ki, theme: wi };
  function gi(t, r, o, ...e) {
  ...
  function $r(t) {
    ...
    return r.length === 0 ? [] : (r.sort((e, i) => it(e.name, i.name)), xi(r));
  }
  function xi(t) {
    let r = [],
      o = null,
      ...
      if (
        (I([c], (h, { path: w }) => {
          ...
          let k = [],
            A = [];
          for (let y of w)
            y.kind === "at-rule" ? k.push(y) : y.kind === "rule" && A.push(y);
      ...
      r.compound("group", 2, (c, m) => {
        ...
        if (
          (I([c], (w, { path: k }) => {
            ...
            for (let b of k.slice(0, -1))
              if (b.kind === "rule") return (h = !1), 2;
    ...
    o("first", ["&:first-child"]),
      ...
      r.functional("aria", (c, m) => {
        ...
        m.value.kind === "arbitrary"
          ? (c.nodes = [L(`&[aria-${Vr(m.value.value)}]`, c.nodes)])
      ...
      r.functional("data", (c, m) => {
        if (!m.value || m.modifier) return null;
        c.nodes = [L(`&[data-${Vr(m.value.value)}]`, c.nodes)];
      }),
      r.functional("nth", (c, m) => {
        if (
          !m.value ||
          m.modifier ||
          (m.value.kind === "named" && !E(m.value.value))
        )
          return null;
      ...
      o("contrast-less", ["@media (prefers-contrast: less)"]);
    {
      ...
      var u = c;
      {
              ...
              case "functional": {
                ...
                return (
                  h.value.kind === "arbitrary"
                    ? (w = h.value.value)
                    : h.value.kind === "named" &&
                      (w = t.resolveValue(h.value.value, ["--breakpoint"])),
        ...
        r.group(
          ...
          r.suggest("max", () =>
            Array.from(m.keys()).filter((h) => h !== null),
          ),
          r.group(
            () => {
              ...
              case "functional": {
                ...
                return (
                  h.value.kind === "arbitrary"
                    ? (w = h.value.value)
                    : h.value.kind === "named" &&
                      (w = t.resolveValue(h.value.value, ["--container"])),
                  !w || w.includes("var(") ? null : w
                );
              }
              case "static":
      ...
      d = {
        ...
        candidatesToCss(u) {
          ...
          for (let m of u) {
            ...
            (h = ve(h, d, 0)),
              h.length === 0 || g ? c.push(null) : c.push(ie(h));
          }
          return c;
        },
        getClassOrder(u) {
        ...
        getVariantOrder() {
          ...
          for (let h of u)
            h !== null &&
              (m !== void 0 && this.variants.compare(m, h) !== 0 && g++,
              c.set(h, g),
              (m = h));
          return c;
        },
  ...
  function ge(t, r, { onInvalidCandidate: o } = {}) {
    ...
    return (
      i.sort((d, u) => {
        let c = e.get(d),
          m = e.get(u);
        if (c.variants - m.variants !== 0n)
          return Number(c.variants - m.variants);
        let g = 0;
        for (
          ;
          g < c.properties.order.length &&
          g < m.properties.order.length &&
          c.properties.order[g] === m.properties.order[g];
    ...
    I([e], (g, { parent: h }) => {
      if (g.kind === "at-rule") {
          ...
          a.get(w).add(g),
            I(g.nodes, (k) => {
              if (!(k.kind !== "at-rule" || k.name !== "@apply")) {
                i.add(g);
                for (let A of zr(k, r)) s.get(g).add(A);
              }
            });
          return;
        }
        if (g.name === "@apply") {
          if (h === null) return;
          (o |= 1), i.add(h);
          for (let w of zr(g, r)) s.get(h).add(w);
        }
      }
    });
    let d = new Set(),
                    ...
                    switch (y.kind) {
                      ...
                      case "functional":
                        if (w.params.replace(/-\*$/, "") === y.root)
                          throw new Error(
                            `You cannot \`@apply\` the \`${b}\` utility here because it creates a circular dependency.`,
                          );
                        break;
                      default:
                    }
...
${ie([w])}`))
        ...
        c.add(g);
        for (let w of s.get(g))
          for (let k of a.get(w)) h.push(g), m(k, h), h.pop();
          ...
          return (
            s.push(
              (async () => {
                ...
                let k = await o(c, r),
                  A = Ce(k.content);
                await Kt(A, k.base, o, e + 1),
                  (w.nodes = $i([ae({ base: k.base }, A)], m, g, h));
              })(),
            ),
            d(w),
            1
  ...
  function lt(t) {
    ...
    for (let r of t) if (!Ti.test(r)) return null;
    return t
    ...
    return function (i, s) {
      ...
      let u = (() => {
        ...
        if (
          ...
          return typeof g != "object" && g & 4 ? (h ?? m) : m;
        if (h !== null && typeof h == "object" && !Array.isArray(h)) {
          ...
          for (let k in m)
            k !== "__CSS_VALUES__" &&
              ((h?.__CSS_VALUES__?.[k] & 4 && Dr(w, k.split("-")) !== void 0) ||
                (w[we(k)] = m[k]));
          return w;
        }
  ...
  function Ri(t, r) {
    ...
    for (let [m, g] of s) {
      ...
      let h = m.indexOf("--"),
        w = m.slice(0, h),
        k = m.slice(h + 2);
      (k = k.replace(/-([a-z])/g, (A, b) => b.toUpperCase())),
        i.get(w === "" ? null : w).set(k, [g, t.getOptions(`--${o}${m}`)]);
    }
    ...
    let u = {},
      c = {};
    for (let [m, g] of e) jr(u, [m ?? "DEFAULT"], g);
    for (let [m, g] of a) jr(c, [m ?? "DEFAULT"], g);
...
`,
          ...
          () => {
            t.variants.functional(a, (g, h) => {
              ...
              if (h.value.kind === "arbitrary")
                g.nodes = c(h.value.value, h.modifier, g.nodes);
          ...
          (g, h) => {
            ...
            if (u && typeof u.sort == "function")
              return u.sort(
                ...
                { value: b, modifier: h.modifier?.value ?? null },
              );
            let y = m.indexOf(w),
              S = m.indexOf(k);
            return (
        ...
        for (let [c, m] of u)
          t.theme.prefix &&
            I(m, (g) => {
              if (g.kind === "rule") {
                ...
                Ie(h, (w) => {
                  w.kind === "selector" &&
                    w.value[0] === "." &&
                    (w.value = `.${t.theme.prefix}\\:${w.value.slice(1)}`);
                }),
                  (g.selector = Fe(h));
              }
            }),
            t.utilities.static(c, (g) => {
              ...
              return Xr(h, c, g.raw), (e.current |= Ue(h, t)), h;
            });
      },
      matchUtilities(a, d) {
        let u = d?.type
        ...
        for (let [m, g] of Object.entries(a)) {
            ...
            return (k) => {
              if (
                ...
                ((k.value.dataType && !u.includes(k.value.dataType)) ||
                  (!k.value.dataType && !q(k.value.value, u)))
              )
                return;
                ...
                y = !1;
              {
                ...
                A &&
                  ...
                  k.value
                    ? k.value.kind === "arbitrary"
                      ? (b = k.value.value)
                      : k.value.fraction && O[k.value.fraction]
                        ? ((b = O[k.value.fraction]), (y = !0))
                        : O[k.value.value]
                          ? (b = O[k.value.value])
                          : O.__BARE_VALUE__ &&
                            ((b = O.__BARE_VALUE__(k.value) ?? null),
                            (y =
                              (k.value.fraction !== null && b?.includes("/")) ??
                              !1))
                    : (b = O.DEFAULT ?? null);
              }
              if (b === null) return;
          ...
          d?.supportsNegativeValues &&
            t.utilities.functional(`-${m}`, h({ negative: !0 }), { types: u }),
  ...
  function se(t) {
    ...
    for (let [e, i] of o)
      if (typeof i != "object") {
        ...
        for (let s of i)
          typeof s == "string" ? r.push(l(e, s)) : r.push(B(e, se(s)));
  ...
  function Dt(t, { config: r, base: o, path: e, reference: i }) {
    ...
    for (let u of r.presets ?? [])
      Dt(t, { path: e, base: o, config: u, reference: i });
    for (let u of s)
      t.plugins.push(u),
        u.config &&
          Dt(t, {
  ...
  function Gi({ center: t, padding: r, screens: o }, e) {
    ...
    if (
      ...
      if ((a.sort((d, u) => be(d[1], u[1], "asc")), a.length > 0)) {
        let [d] = a[0];
        i.push(
          j("@media", `(width >= --theme(--breakpoint-${d}))`, [
            l("max-width", "none"),
          ]),
        );
      }
      ...
      r.variants.functional(
        ...
        (u, c) => {
          ...
          return m && m.kind === "named" && m.value in e
            ? a?.(u, { ...c, value: { kind: "arbitrary", value: e[m.value] } })
            : a?.(u, c);
        },
        { compounds: d },
      );
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
          ...
          a.push([
            { id: A, base: k.base, reference: !!k.reference },
  ...
  function co({
    ...
    let w = {
      ...
      A;
    for (let { handler: b, reference: y } of c.plugins)
      y ? ((A ||= Ut({ ...w, referenceMode: !0 })), b(A)) : b(k);
    if (
      (Kr(t, m, g),
      eo(t, m, g),
      uo(m, t),
    ...
    if (
      ...
      I(o, (y, { replaceWith: S, parent: V }) => {
        if (
          y.kind === "at-rule" &&
          !(y.name !== "@tailwind" || y.params !== "utilities")
        )
...
This feature is not currently supported.`);
  ...
  function dt(t) {
    ...
    let d = i.slice(1, a),
      u = i.slice(a + 1),
      c;
    Qi(d) ? (c = Zi(d)) : (c = z(d, ",")), (c = c.flatMap((g) => dt(g)));
    let m = dt(u);
  ...
  async function on(
    ...
    let s = null,
      ...
      k = [],
      A = null;
    I(t, (y, { parent: S, replaceWith: V, context: O }) => {
      if (y.kind === "at-rule") {
        if (
          y.name === "@tailwind" &&
        ...
        if (y.name === "@source") {
          ...
          } else h.push({ base: O.base, pattern: Y, negated: _ });
          V([]);
          return;
        }
        if (
          ...
          if (y.nodes.length === 0) {
            ...
            let P = z(D.slice(1, -1), ",");
            if (P.length === 0 || P.some((F) => F.trim() === ""))
              throw new Error(
                `\`@custom-variant ${_} (${P.join(",")})\` selector is invalid.`,
              );
            let Y = [],
              M = [];
            for (let F of P)
              (F = F.trim()), F[0] === "@" ? Y.push(F) : M.push(F);
            d.push((F) => {
              F.variants.static(
                _,
                (oe) => {
        ...
        if (y.name === "@media") {
          ...
          for (let P of _)
            if (P.startsWith("source(")) {
              ...
              let Y = P.slice(7, -1);
              I(y.nodes, (M) => {
                if (M.kind === "at-rule" && M.name === "@theme")
                  return (M.params += ` prefix(${Y})`), 1;
              });
            } else
              P === "important"
                ? (s = !0)
                : P === "reference"
                  ? (y.nodes = [ae({ reference: !0 }, y.nodes)])
                  : D.push(P);
          D.length > 0 ? (y.params = D.join(" ")) : _.length > 0 && V(y.nodes);
        }
        if (y.name === "@theme") {
          let [_, D] = rn(y.params);
          if ((O.reference && (_ |= 2), D)) {
            if (!Xi.test(D))
              throw new Error(
          ...
          return (
            I(y.nodes, (P) => {
              if (P.kind === "at-rule" && P.name === "@keyframes")
                return a.addKeyframes(P), 1;
...
${Y}`);
    ...
    let b = Rr(a);
    if ((s && (b.important = s), k.length > 0))
      for (let y of k) b.invalidCandidates.add(y);
    i |= await fo({
      designSystem: b,
      base: r,
      ast: t,
    ...
    if (c) {
      let y = [];
      for (let [V, O] of b.theme.entries())
        O.options & 2 || y.push(l(de(V), O.value));
    ...
    if (g.length > 0) {
      for (let y of g) {
        let S = L("&", y.nodes),
          ...
          O = b.parseVariant(V);
        if (O === null)
          throw new Error(`Cannot use \`@variant\` with unknown variant: ${V}`);
        if (Te(S, O, b.variants) === null)
          throw new Error(`Cannot use \`@variant\` with variant: ${V}`);
        Object.assign(y, S);
      }
      i |= 32;
    }
  ...
  async function nn(t, r = {}) {
    ...
    e.unshift(
      He(`! tailwindcss v${Mt} | MIT License | https://tailwindcss.com `),
    );
    function c(k) {
      ...
      build(k) {
        ...
        for (let V of k)
          if (!o.invalidCandidates.has(V))
            if (V[0] === "-" && V[1] === "-") {
              let O = o.theme.markUsedVariable(V);
              (A ||= O), (b ||= O);
            } else m.add(V), (A ||= m.size !== y);
        if (!A) return (g ??= ve(e, o, r.polyfills)), g;
        let S = ge(m, o, { onInvalidCandidate: c }).astNodes;
        return !b && h === S.length
          ? ((g ??= ve(e, o, r.polyfills)), g)
          : ((h = S.length), (a.nodes = S), (g = ve(e, o, r.polyfills)), g);
      },
    };
  }
...
`;
  var wo = `@tailwind utilities;
`;
  var Le = { index: go, preflight: ho, theme: ko, utilities: wo };
  var pt = class {
    start(r) {
...
`);
    if (
      ...
      X.end("Reading Stylesheets", { size: r.length, changed: It !== r }),
      It !== r)
    ) {
      (It = r), X.start("Compile CSS");
      try {
        mt = await mo(r, { base: "/", loadStylesheet: mn, loadModule: gn });
      } finally {
  ...
  async function mn(t, r) {
    function o() {
      ...
      if (
        ...
        return { base: r, content: Le.preflight };
      if (
        t === "tailwindcss/theme" ||
        t === "tailwindcss/theme.css" ||
        t === "./theme.css"
      )
        return { base: r, content: Le.theme };
      if (
        t === "tailwindcss/utilities" ||
        t === "tailwindcss/utilities.css" ||
        t === "./utilities.css"
      )
        return { base: r, content: Le.utilities };
  ...
  async function hn(t) {
    ...
    for (let o of document.querySelectorAll("[class]"))
      for (let e of o.classList) Ft.has(e) || (Ft.add(e), r.add(e));
    X.end("Collect classes", { count: r.size }),
      !(r.size === 0 && t === "incremental") &&
        (X.start("Build utilities"),
        (Lt.textContent = mt.build(Array.from(r))),
  ...
  var kn = new MutationObserver(() => gt("full"));
  function yo(t) {
    kn.observe(t, {
      attributes: !0,
